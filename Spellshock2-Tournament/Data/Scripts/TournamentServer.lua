...
local POINTS_PER_KILL_WILD = 22 -- 5
local POINTS_PER_ASSIST = 12
...
local POINTS_PER_HEALING_DONE = 0.475 -- .075
...
local SOFTCAP_KILLSTREAK_COUNT = 8
local SOFTCAP_KILLSTREAK_REDUCTION = 10
...
local SOFTCAP_HEALING_COUNT = 2000
