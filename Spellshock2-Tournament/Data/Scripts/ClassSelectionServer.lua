...
local function EquipPlayer(player, classID)
    ...
    newClass:SetCustomProperty("OID", oId)
    newClass:SetCustomProperty("QID", qId)
    newClass:SetCustomProperty("EID", eId)
    newClass:SetCustomProperty("RID", rId)
    newClass:SetCustomProperty("TID", tId)
    Task.Wait()
    ...
    elseif newState == ABGS.GAME_STATE_ROUND_END and oldState ~= ABGS.GAME_STATE_ROUND_END then
        ...
        for _, player in ipairs(Game.GetPlayers()) do
            ...
            if Object.IsValid(player) then
                ...
                newOutfit:SetCustomProperty("OID", skinId)
                newOutfit:SetCustomProperty("ClassID", classID)
