...
Task.Wait()
Ease3D.EasePosition(ARROW, Vector3.New(0, 0, 1000), DURATION/2, Ease3D.EasingEquation.CUBIC, Ease3D.EasingDirection.OUT)
Ease3D.EaseRotation(ARROW, Rotation.New(0, 20, 0), DURATION, Ease3D.EasingEquation.SINE, Ease3D.EasingDirection.INOUT)
