...
Ease3D.EaseScale(Shield, Vector3.New(.6), .5, Ease3D.EasingEquation.BACK, Ease3D.EasingDirection.INOUT)
Ease3D.EasePosition(Shield, Vector3.New(0, 0, -10), .5, Ease3D.EasingEquation.CUBIC, Ease3D.EasingDirection.OUT)
Ease3D.EaseRotation(Shield, Rotation.New(180, 0, 360), .5, Ease3D.EasingEquation.SINE, Ease3D.EasingDirection.IN)
Task.Wait(.5)
