...
function OnBeginOverlap(thisTrigger, other)
	...
	local damageTable = META_AP().GetAbilityMod(ABILITY.owner, META_AP().Q, "mod1", DEFAULT_DamageRange, ABILITY.name..": Damage Range")
	local healTable = META_AP().GetAbilityMod(ABILITY.owner, META_AP().Q, "mod2", DEFAULT_HealRange, ABILITY.name..": Heal Range")
