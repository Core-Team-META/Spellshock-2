...
classTable = {
    ...
    [CONST.CLASS.HUNTER] = {
        ...
        [CONST.BIND.LMB] = {
            -- mod1 = Damage Range
            [1] = {mod1 = {min = 35, max = 52}, mod2 = 0, mod3 = 0, mod4 = 0, mod5 = {duration = 1.5, damage = 0, multiplier = 0.6}, mod6 = 0.35},
            [2] = {mod1 = {min = 36, max = 56}, mod2 = 0, mod3 = 0, mod4 = 0, mod5 = {duration = 1.5, damage = 0, multiplier = 0.6}, mod6 = 0.35},
            [3] = {mod1 = {min = 37, max = 60}, mod2 = 0, mod3 = 0, mod4 = 0, mod5 = {duration = 1.5, damage = 0, multiplier = 0.6}, mod6 = 0.35},
            [4] = {mod1 = {min = 38, max = 62}, mod2 = 0, mod3 = 0, mod4 = 0, mod5 = {duration = 1.5, damage = 0, multiplier = 0.6}, mod6 = 0.35},
            [5] = {mod1 = {min = 40, max = 64}, mod2 = 0, mod3 = 0, mod4 = 0, mod5 = {duration = 1.5, damage = 0, multiplier = 0.6}, mod6 = 0.35},
            [6] = {mod1 = {min = 42, max = 66}, mod2 = 0, mod3 = 0, mod4 = 0, mod5 = {duration = 1.5, damage = 0, multiplier = 0.6}, mod6 = 0.35},
            [7] = {mod1 = {min = 44, max = 68}, mod2 = 0, mod3 = 0, mod4 = 0, mod5 = {duration = 1.5, damage = 0, multiplier = 0.6}, mod6 = 0.35},
            [8] = {mod1 = {min = 50, max = 72}, mod2 = 0, mod3 = 0, mod4 = 0, mod5 = {duration = 1.5, damage = 0, multiplier = 0.6}, mod6 = 0.35},
            [9] = {mod1 = {min = 55, max = 75}, mod2 = 0, mod3 = 0, mod4 = 0, mod5 = {duration = 1.5, damage = 0, multiplier = 0.6}, mod6 = 0.35},
           [10] = {mod1 = {min = 65, max = 85}, mod2 = 0, mod3 = 0, mod4 = 0, mod5 = {duration = 1.5, damage = 0, multiplier = 0.6}, mod6 = 0.35}
        },
        --Aim
        [CONST.BIND.RMB] = {
            [1] = {mod1 = 0, mod2 = 0, mod3 = 0, mod4 = 0, mod5 = 0, mod6 = 0},
