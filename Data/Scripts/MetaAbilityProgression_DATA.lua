...
classTable = {
    ...
    [CONST.CLASS.TANK] = {
        ...
        [CONST.BIND.LMB] = {
            -- mod1 = Damage Range
            [1] = {mod1 = {min = 75, max = 90}, mod2 = 2.0, mod3 = 0, mod4 = 0, mod5 = 2, mod6 = 0.6},
            [2] = {mod1 = {min = 80, max = 95}, mod2 = 2.0, mod3 = 0, mod4 = 0, mod5 = 2, mod6 = 0.58},
            [3] = {mod1 = {min = 85, max = 100}, mod2 = 2.0, mod3 = 0, mod4 = 0, mod5 = 2, mod6 = 0.56},
            [4] = {mod1 = {min = 90, max = 105}, mod2 = 2.0, mod3 = 0, mod4 = 0, mod5 = 2, mod6 = 0.54},
            [5] = {mod1 = {min = 95, max = 110}, mod2 = 2.0, mod3 = 0, mod4 = 0, mod5 = 2, mod6 = 0.52},
            [6] = {mod1 = {min = 100, max = 115}, mod2 = 2.0, mod3 = 0, mod4 = 0, mod5 = 2, mod6 = 0.5},
            [7] = {mod1 = {min = 105, max = 120}, mod2 = 2.0, mod3 = 0, mod4 = 0, mod5 = 2, mod6 = 0.47},
            [8] = {mod1 = {min = 110, max = 125}, mod2 = 2.0, mod3 = 0, mod4 = 0, mod5 = 2, mod6 = 0.44},
            [9] = {mod1 = {min = 115, max = 130}, mod2 = 2.0, mod3 = 0, mod4 = 0, mod5 = 2, mod6 = 0.42},
           [10] = {mod1 = {min = 120, max = 140}, mod2 = 2.0, mod3 = 0, mod4 = 0, mod5 = 2, mod6 = 0.35}
        },
        --Block
        [CONST.BIND.RMB] = {
            -- mod1 = Block %
    ...
    [CONST.CLASS.HEALER] = {
        ...
        [CONST.BIND.T] = {
            ...
            [1] = {mod1 = 180, mod2 = 95, mod3 = 1350, mod4 = 5000, mod5 = {duration = 2.25, damage = 0, multiplier = 0}, mod6 = 50},
            [2] = {mod1 = 185, mod2 = 100, mod3 = 1350, mod4 = 5000, mod5 = {duration = 2.35, damage = 0, multiplier = 0}, mod6 = 49},
            [3] = {mod1 = 190, mod2 = 105, mod3 = 1350, mod4 = 5000, mod5 = {duration = 2.45, damage = 0, multiplier = 0}, mod6 = 48},
            [4] = {mod1 = 195, mod2 = 110, mod3 = 1350, mod4 = 5000, mod5 = {duration = 2.55, damage = 0, multiplier = 0}, mod6 = 47},
            [5] = {mod1 = 200, mod2 = 115, mod3 = 1350, mod4 = 5000, mod5 = {duration = 2.65, damage = 0, multiplier = 0}, mod6 = 46},
            [6] = {mod1 = 205, mod2 = 125, mod3 = 1350, mod4 = 5000, mod5 = {duration = 2.75, damage = 0, multiplier = 0}, mod6 = 45},
            [7] = {mod1 = 210, mod2 = 135, mod3 = 1350, mod4 = 5000, mod5 = {duration = 2.85, damage = 0, multiplier = 0}, mod6 = 44},
            [8] = {mod1 = 215, mod2 = 145, mod3 = 1350, mod4 = 5000, mod5 = {duration = 2.95, damage = 0, multiplier = 0}, mod6 = 43},
            [9] = {mod1 = 235, mod2 = 160, mod3 = 1350, mod4 = 5000, mod5 = {duration = 3.15, damage = 0, multiplier = 0}, mod6 = 42},
           [10] = {mod1 = 255, mod2 = 175, mod3 = 1350, mod4 = 5000, mod5 = {duration = 3.35, damage = 0, multiplier = 0}, mod6 = 41}
        },
        --Teleport
        [CONST.BIND.SHIFT] = {
        ...
        [CONST.BIND.LMB] = {
            ...
            [1] = {mod1 = {min = 35, max = 42}, mod2 = 20, mod3 = 0, mod4 = 0, mod5 = 0, mod6 = 0.9},
            [2] = {mod1 = {min = 37, max = 44}, mod2 = 20, mod3 = 0, mod4 = 0, mod5 = 0, mod6 = 0.87},
            [3] = {mod1 = {min = 39, max = 46}, mod2 = 20, mod3 = 0, mod4 = 0, mod5 = 0, mod6 = 0.84},
            [4] = {mod1 = {min = 41, max = 48}, mod2 = 20, mod3 = 0, mod4 = 0, mod5 = 0, mod6 = 0.82},
            [5] = {mod1 = {min = 43, max = 50}, mod2 = 20, mod3 = 0, mod4 = 0, mod5 = 0, mod6 = 0.78},
            [6] = {mod1 = {min = 45, max = 52}, mod2 = 20, mod3 = 0, mod4 = 0, mod5 = 0, mod6 = 0.74},
            [7] = {mod1 = {min = 47, max = 54}, mod2 = 20, mod3 = 0, mod4 = 0, mod5 = 0, mod6 = 0.7},
            [8] = {mod1 = {min = 49, max = 56}, mod2 = 20, mod3 = 0, mod4 = 0, mod5 = 0, mod6 = 0.67},
            [9] = {mod1 = {min = 51, max = 58}, mod2 = 20, mod3 = 0, mod4 = 0, mod5 = 0, mod6 = 0.64},
           [10] = {mod1 = {min = 55, max = 62}, mod2 = 20, mod3 = 0, mod4 = 0, mod5 = 0, mod6 = 0.6}
        },
        --Aim
        [CONST.BIND.RMB] = {
            [1] = {mod1 = 0, mod2 = 0, mod3 = 0, mod4 = 0, mod5 = 0, mod6 = 0},
    ...
    [CONST.CLASS.ASSASSIN] = {
        ...
        [CONST.BIND.E] = {
            ...
            [1] = {mod1 = 85, mod2 = 650, mod3 = 11, mod4 = 1250, mod5 = {duration = 3, damage = 0, multiplier = 0}, mod6 = 32},
            [2] = {mod1 = 87, mod2 = 650, mod3 = 12, mod4 = 1250, mod5 = {duration = 3, damage = 0, multiplier = 0}, mod6 = 31},
            [3] = {mod1 = 89, mod2 = 650, mod3 = 13, mod4 = 1250, mod5 = {duration = 3, damage = 0, multiplier = 0}, mod6 = 30},
            [4] = {mod1 = 91, mod2 = 650, mod3 = 14, mod4 = 1250, mod5 = {duration = 3, damage = 0, multiplier = 0}, mod6 = 29},
            [5] = {mod1 = 93, mod2 = 650, mod3 = 15, mod4 = 1250, mod5 = {duration = 3, damage = 0, multiplier = 0}, mod6 = 28},
            [6] = {mod1 = 95, mod2 = 650, mod3 = 16, mod4 = 1250, mod5 = {duration = 3, damage = 0, multiplier = 0}, mod6 = 27},
            [7] = {mod1 = 97, mod2 = 650, mod3 = 16, mod4 = 1250, mod5 = {duration = 3, damage = 0, multiplier = 0}, mod6 = 27},
            [8] = {mod1 = 99, mod2 = 650, mod3 = 17, mod4 = 1250, mod5 = {duration = 3, damage = 0, multiplier = 0}, mod6 = 26},
            [9] = {mod1 = 105, mod2 = 650, mod3 = 17, mod4 = 1250, mod5 = {duration = 3, damage = 0, multiplier = 0}, mod6 = 26},
           [10] = {mod1 = 110, mod2 = 650, mod3 = 18, mod4 = 1250, mod5 = {duration = 3, damage = 0, multiplier = 0}, mod6 = 25}
        },
        --Venom Bomb
        [CONST.BIND.R] = {
            -- mod1 = Damage Amount, mod2 = Damage Radius, mod3 = Projectile Speed, mod4 = Status Effect Slow, mod 5 = Status Effect Poison
            [1] = {mod1 = 45, mod2 = 800, mod3 = 5000, mod4 = {duration = 4, damage = 0, multiplier = 0.3}, mod5 = {duration = 5.0, damage = 10, multiplier = 0}, mod6 = 3},
            [2] = {mod1 = 50, mod2 = 825, mod3 = 5000, mod4 = {duration = 4, damage = 0, multiplier = 0.3}, mod5 = {duration = 5.0, damage = 11, multiplier = 0}, mod6 = 3},
            [3] = {mod1 = 50, mod2 = 875, mod3 = 5000, mod4 = {duration = 4, damage = 0, multiplier = 0.3}, mod5 = {duration = 6.0, damage = 12, multiplier = 0}, mod6 = 3},
            [4] = {mod1 = 55, mod2 = 925, mod3 = 5000, mod4 = {duration = 4, damage = 0, multiplier = 0.3}, mod5 = {duration = 6.0, damage = 13, multiplier = 0}, mod6 = 3},
            [5] = {mod1 = 55, mod2 = 950, mod3 = 5000, mod4 = {duration = 4, damage = 0, multiplier = 0.3}, mod5 = {duration = 7.0, damage = 14, multiplier = 0}, mod6 = 3},
            [6] = {mod1 = 60, mod2 = 970, mod3 = 5000, mod4 = {duration = 4, damage = 0, multiplier = 0.3}, mod5 = {duration = 7.0, damage = 15, multiplier = 0}, mod6 = 3},
            [7] = {mod1 = 60, mod2 = 990, mod3 = 5000, mod4 = {duration = 4, damage = 0, multiplier = 0.3}, mod5 = {duration = 7.0, damage = 16, multiplier = 0}, mod6 = 3},
            [8] = {mod1 = 70, mod2 = 1010, mod3 = 5000, mod4 = {duration = 4, damage = 0, multiplier = 0.3}, mod5 = {duration = 8.0, damage = 17, multiplier = 0}, mod6 = 3},
            [9] = {mod1 = 70, mod2 = 1030, mod3 = 5000, mod4 = {duration = 4, damage = 0, multiplier = 0.3}, mod5 = {duration = 8.0, damage = 18, multiplier = 0}, mod6 = 3},
           [10] = {mod1 = 75, mod2 = 1050, mod3 = 5000, mod4 = {duration = 4, damage = 0, multiplier = 0.3}, mod5 = {duration = 8.0, damage = 20, multiplier = 0}, mod6 = 3}
        },
        --Wraith Strike
        [CONST.BIND.T] = {
            -- mod1 = Damage Range, mod2 = Placement Range, mod3 = Heal Amount, mod4 = Flying Duration, mod 5 = Status Effect Stun
            [1] = {mod1 = {min = 130, max = 150}, mod2 = 6000, mod3 = 90, mod4 = 5, mod5 = {duration = 4.0, damage = 0, multiplier = 0}, mod6 = 52},
            [2] = {mod1 = {min = 140, max = 165}, mod2 = 6000, mod3 = 96, mod4 = 5.2, mod5 = {duration = 4.0, damage = 0, multiplier = 0}, mod6 = 51},
            [3] = {mod1 = {min = 155, max = 180}, mod2 = 6000, mod3 = 102, mod4 = 5.4, mod5 = {duration = 4.0, damage = 0, multiplier = 0}, mod6 = 50},
            [4] = {mod1 = {min = 160, max = 190}, mod2 = 6000, mod3 = 106, mod4 = 5.6, mod5 = {duration = 4.0, damage = 0, multiplier = 0}, mod6 = 49},
            [5] = {mod1 = {min = 165, max = 195}, mod2 = 6000, mod3 = 110, mod4 = 5.8, mod5 = {duration = 4.0, damage = 0, multiplier = 0}, mod6 = 48},
            [6] = {mod1 = {min = 170, max = 200}, mod2 = 6000, mod3 = 114, mod4 = 6, mod5 = {duration = 4.0, damage = 0, multiplier = 0}, mod6 = 47},
            [7] = {mod1 = {min = 175, max = 205}, mod2 = 6000, mod3 = 118, mod4 = 6.2, mod5 = {duration = 4.0, damage = 0, multiplier = 0}, mod6 = 46},
            [8] = {mod1 = {min = 180, max = 210}, mod2 = 6000, mod3 = 122, mod4 = 6.4, mod5 = {duration = 4.0, damage = 0, multiplier = 0}, mod6 = 45},
            [9] = {mod1 = {min = 185, max = 215}, mod2 = 6000, mod3 = 124, mod4 = 6.7, mod5 = {duration = 4.0, damage = 0, multiplier = 0}, mod6 = 44},
           [10] = {mod1 = {min = 190, max = 220}, mod2 = 6000, mod3 = 126, mod4 = 7, mod5 = {duration = 4.0, damage = 0, multiplier = 0}, mod6 = 43}
        },
        --Roll
        [CONST.BIND.SHIFT] = {
            [1] = {mod1 = 0, mod2 = 0, mod3 = 0, mod4 = 0, mod5 = 0, mod6 = 0.5},
